...
fun ResumenScreen(viewModel: UsuarioViewModel) {
    ...
    Column (Modifier.padding(16.dp)){
        ...
        Text("Nombre de usuario: ${estado.userName}")
        Text("Nombre completo: ${estado.fullName}")
        Text("Correo electronico: ${estado.email}")
        Text("Contraseña: ${"*".repeat(estado.password.length)}")
        Text("Confirma contraseña: ${"*".repeat(estado.confirmPassword.length)}")
